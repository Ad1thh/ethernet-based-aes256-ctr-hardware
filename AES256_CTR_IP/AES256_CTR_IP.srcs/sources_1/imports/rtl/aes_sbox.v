...
// Description:
//   Standard AES S-Box combinational lookup table.
//////////////////////////////////////////////////////////////////////////////////
...
module aes_sbox (
    ...
    always @(*) begin
        case (in_byte)
            ...
            8'h54: out_byte = 8'h20; 8'h55: out_byte = 8'hfc; 8'h56: out_byte = 8'hb1; 8'h57: out_byte = 8'hb5;
            ...
            8'h9c: out_byte = 8'hde; 8'h9d: out_byte = 8'h5e; 8'h0b: out_byte = 8'h0b; 8'h9f: out_byte = 8'hdb; // Fixed byte 9e issue from previous table
